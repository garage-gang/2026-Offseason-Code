...
public class ShootCommand extends Command {
	...
	private static final LoggedTunableNumber elevatorVoltageConfig = new LoggedTunableNumber(
	        "Elevator/Elevator/Velocity", 11.5);

	public ShootCommand(Elevator elevator, PrimeShootCommand primeShootCommand,
	        PrimeShootCommand simplePrimeShootCommand, PrimeShootCommand alliancePrimeShootCommand) {
	...
	@Override
	public void execute() {
		if (primeShootCommand.isPrimed() || simplePrimeShootCommand.isPrimed() || alliancePrimeShootCommand.isPrimed())
