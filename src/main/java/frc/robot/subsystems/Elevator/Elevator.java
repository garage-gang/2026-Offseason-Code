...
public class Elevator extends SubsystemBase {
	...
	private static final LoggedTunableNumber elevatorTargetAccelerationConfig = new LoggedTunableNumber(
	        "Elevator/Acceleration");
	private static final LoggedTunableNumber elevatorMaxVelocityConfig = new LoggedTunableNumber(
	...
	public void periodic() {
		...
		int hc = hashCode();
		if (eleKP.hasChanged(hc) || eleKV.hasChanged(hc) || elevatorMaxVelocityConfig.hasChanged(hc)
		        || elevatorTargetAccelerationConfig.hasChanged(hc))
			configElevator();
