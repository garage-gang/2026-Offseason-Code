...
public class ModuleIOSim implements ModuleIO {
	...
	public ModuleIOSim() {
		...
		driveSim = new DCMotorSim(LinearSystemId.createDCMotorSystem(DRIVE_GEARBOX, 0.025, DRIVE_MOTOR_REDUCTION),
		        DRIVE_GEARBOX);
		turnSim = new DCMotorSim(LinearSystemId.createDCMotorSystem(turnGearbox, 0.004, turnMotorReduction),
		        turnGearbox);
