...
public class IntakeIOSim implements IntakeIO {
	...
	private TalonFXSim rollerMotor = new TalonFXSim(DCMotor.getKrakenX60Foc(1), RollerConstants.ROLLER_GEARING,
	        RollerConstants.ROLLER_MOI);

	private TalonFXArmSim extenderSim = new TalonFXArmSim(new SingleJointedArmSim(DCMotor.getFalcon500Foc(1),
	        frc.robot.Constants.IntakeConstants.ExtenderConstants.GEAR_RATIO, ExtenderConstants.EXTENDER_MOI,
	        ExtenderConstants.EXTENDER_LENGTH.in(Units.Meters), ExtenderConstants.MIN_EXTENDER_ANGLE.getRadians(),
	        ExtenderConstants.MAX_EXTENDER_ANGLE.getRadians(), false, 0));
