...
public class IntakeIOReal implements IntakeIO {
	...
	private final MotionMagicVelocityVoltage rollerClosedLoopControl = new MotionMagicVelocityVoltage(0)
	        .withEnableFOC(false);

	private final MotionMagicVoltage extenderClosedLoopControl = new MotionMagicVoltage(0).withEnableFOC(false);
	...
	public IntakeIOReal() {
		...
		BaseStatusSignal.setUpdateFrequencyForAll(50, rollerAppliedVoltage, rollerCurrent, rollerVelocity);
		...
		extenderConfig.SoftwareLimitSwitch.ForwardSoftLimitThreshold = ExtenderConstants.MAX_EXTENDER_ANGLE
		        .getRotations();
		extenderConfig.SoftwareLimitSwitch.ReverseSoftLimitThreshold = ExtenderConstants.MIN_EXTENDER_ANGLE
		        .minus(Rotation2d.fromDegrees(2.0)).getRotations();
	...
	public void updateInputs(IntakeInputs inputs) {
		BaseStatusSignal.refreshAll(rollerAppliedVoltage, rollerCurrent, rollerDeviceTemp, rollerVelocity,
		        extenderAngle, extenderCurrent, extenderAppliedVoltage, extenderDeviceTemp);
