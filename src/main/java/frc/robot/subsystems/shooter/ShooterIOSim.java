...
public class ShooterIOSim implements ShooterIO {
	...
	private TalonFXSim wheelMotor = new TalonFXSim(DCMotor.getKrakenX60Foc(1), WheelConstants.WHEEL_GEARING,
	        WheelConstants.WHEEL_MOI);

	private TalonFXArmSim hoodSim = new TalonFXArmSim(new SingleJointedArmSim(DCMotor.getFalcon500Foc(1), 1,
	        HoodConstants.HOOD_MOI, HoodConstants.HOOD_LENGTH.in(Units.Meters),
	        HoodConstants.MIN_HOOD_ANGLE.getRadians(), HoodConstants.MAX_HOOD_ANGLE.getRadians(), false, 0));

	private TalonFXArmSim rotationSim = new TalonFXArmSim(new SingleJointedArmSim(DCMotor.getKrakenX60Foc(1),
	        frc.robot.Constants.ShooterConstants.RotationConstants.GEAR_RATIO, RotationConstants.ROTATION_MOI, 0.5,
	        RotationConstants.MIN_ROTATION_ANGLE.getRadians(), RotationConstants.MAX_ROTATION_ANGLE.getRadians(), false,
	        0));
