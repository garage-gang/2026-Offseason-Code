...
public class ShooterIOReal implements ShooterIO {
	...
	private final MotionMagicVelocityVoltage wheelClosedLoopControl = new MotionMagicVelocityVoltage(0)
	        .withEnableFOC(false);

	private final MotionMagicVoltage rotationClosedLoopControl = new MotionMagicVoltage(0).withEnableFOC(false);

	private final MotionMagicVoltage hoodClosedLoopControl = new MotionMagicVoltage(0).withEnableFOC(false);
	...
	public ShooterIOReal() {
		...
		hoodConfig.SoftwareLimitSwitch.ForwardSoftLimitThreshold = HoodConstants.MAX_HOOD_ANGLE.getRotations();
		hoodConfig.SoftwareLimitSwitch.ReverseSoftLimitThreshold = HoodConstants.MIN_HOOD_ANGLE.getRotations();
		...
		turretConfig.SoftwareLimitSwitch.ForwardSoftLimitThreshold = RotationConstants.MAX_ROTATION_ANGLE
		        .getRotations();
		turretConfig.SoftwareLimitSwitch.ReverseSoftLimitThreshold = RotationConstants.MIN_ROTATION_ANGLE
		        .getRotations();
	...
	public void updateInputs(ShooterInputs inputs) {
		BaseStatusSignal.refreshAll(wheelAppliedVoltage, wheelCurrent, wheelDeviceTemp, wheelVelocity, hoodAngle,
		        hoodCurrent, hoodAppliedVoltage, hoodDeviceTemp, turretAngle, turretCurrent, turretAppliedVoltage,
		        turretDeviceTemp);
