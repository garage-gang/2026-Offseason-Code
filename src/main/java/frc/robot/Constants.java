...
public final class Constants {
		...
		public static Translation2d targetedTrenchDirection(Pose2d robotPose) {
			...
			if (DriverStation.getAlliance().get().equals(Alliance.Blue)) {
				if (robotPose.getY() > FIELD_WIDTH / 2.0) {
					...
					trenchTurretDecision = BLUE_ALLIANCE_TOP_POSITION;
			} else {

				if (robotPose.getY() > FIELD_WIDTH / 2.0) {
					trenchTurretDecision = RED_ALLIANCE_BOTTOM_POSITION;
				} else
					trenchTurretDecision = RED_ALLIANCE_TOP_POSITION;
			}
	...
	public final class ShooterConstants {
		...
		public static final InterpolatingDoubleTreeMap FLYWHEEL_HUB_DISTANCE_SPEED_TABLE = new InterpolatingDoubleTreeMap();
		...
		static {
			...
			FLYWHEEL_HUB_DISTANCE_SPEED_TABLE.put(1.994, 3700.0);
			FLYWHEEL_HUB_DISTANCE_SPEED_TABLE.put(3.217, 4000.0);
			FLYWHEEL_HUB_DISTANCE_SPEED_TABLE.put(4.788, 5000.0);
			FLYWHEEL_HUB_DISTANCE_SPEED_TABLE.put(5.686, 5700.0);
		}

		public static final InterpolatingDoubleTreeMap HOOD_HUB_DISTANCE_ANGLE_TABLE = new InterpolatingDoubleTreeMap();
		...
		public static final InterpolatingDoubleTreeMap FLYWHEEL_ALLIANCE_DISTANCE_SPEED_TABLE = new InterpolatingDoubleTreeMap();
		...
		public static final InterpolatingDoubleTreeMap HOOD_ALLIANCE_DISTANCE_ANGLE_TABLE = new InterpolatingDoubleTreeMap();
